...
h.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"首页",sLast:"尾页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"暂无数据",sInfo:"每页显示 _START_ 到 _END_ 总共 _TOTAL_ 条记录",sInfoEmpty:"每页显示 0 到 0 总共 0 条记录",sInfoFiltered:"(从 _MAX_ 条数据中检索)",
sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"显示 _MENU_ 条记录",sLoadingRecords:"Loading...",sProcessing:"正在加载中...",sSearch:"搜索:",sUrl:"",sZeroRecords:"没有符合条件的数据"},oSearch:i.extend({},l.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET"};l.defaults.columns={aDataSort:null,asSorting:["asc","desc"],bSearchable:true,bSortable:true,
